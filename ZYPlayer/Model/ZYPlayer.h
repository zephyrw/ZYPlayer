...
FOUNDATION_EXPORT NSString * const kNotificationPlayerStateChangeKey;
FOUNDATION_EXPORT NSString * const kNotificationPlayerProgressChangeKey;
FOUNDATION_EXPORT NSString * const kNotificationDecodeErrorKey;
FOUNDATION_EXPORT NSString * const kCurrentKey;
FOUNDATION_EXPORT NSString * const kPreviousKey;
FOUNDATION_EXPORT NSString * const kTotoalKey;
FOUNDATION_EXPORT NSString * const kPercentKey;
FOUNDATION_EXPORT NSString * const kErrorKey;
