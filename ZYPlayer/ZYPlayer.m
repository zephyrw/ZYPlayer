...
NSString * const kNotificationPlayerStateChangeKey = @"kNotificationPlayerStateKey";
NSString * const kNotificationPlayerProgressChangeKey = @"kNotificationPlayerProgressChangeKey";
NSString * const kNotificationDecodeErrorKey = @"kNotificationDecodeErrorKey";

NSString * const kCurrentKey = @"kCurrentStateKey";
NSString * const kPreviousKey = @"kPreviousStateKey";
NSString * const kTotoalKey = @"kTotoalKey";
NSString * const kPercentKey = @"kPercentKey";
NSString * const kErrorKey = @"kErrorKey";
